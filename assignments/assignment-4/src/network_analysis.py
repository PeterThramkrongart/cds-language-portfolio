'''
 A script to load a weighted edgelist as a csv - wile with the columns "nodeA", "nodeB", and "weight".
...
def main(
  input_file = os.path.join("..", "data", "interim", "edges_df.csv"), 
  ...
  Input:
    input_file,   default: ../data/interim/edges_df.csv,                              description: str, path to the input_file,
...
if __name__ =="__main__":
    ...
    ap.add_argument("-i", "--input_file", default = os.path.join("..", "data", "interim", "edges_df.csv"),
